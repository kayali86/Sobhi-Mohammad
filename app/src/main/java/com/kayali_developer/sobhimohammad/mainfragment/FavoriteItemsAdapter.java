...
public class FavoriteItemsAdapter extends RecyclerView.Adapter<FavoriteItemsAdapter.PlayListItemsViewHolder> {
    ...
    FavoriteItemsAdapter(FavoriteItemsAdapterListener mFavoriteItemsAdapterListener) {
        ...
        if (item.getSnippet().getThumbnails() != null && item.getSnippet().getThumbnails().getHigh()!= null){
            ...
            holder.item_play_list_item.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    mItemsAdapterListener.onPlayListItemLongClicked(item);
                    return true;
                }
            });
    ...
    public List<PlayListItemsResponse.Item> getAllItems(){
        return mItems;
    }
